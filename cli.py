...
from dotfiles.plan import Plan, debug_print_plan
from dotfiles.install import plan_install_paths, plan_install
...
@click.option("--dry-run", default=True,
              help="Print a list of what would be done; don't actually do it.")
@click.pass_context
